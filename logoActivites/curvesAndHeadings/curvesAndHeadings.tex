...
polygon. Both \lc{:n} and \lc{:s} are NUMBERS that you should
FILL-IN. So for example, \lc{repeat 17 [ fd 20 rt 360/17 ]}, draws
\begin{logoout}
...
repeat 10 [ pu
  ...
  pd star ]
\end{logo}
NOTE: The stars are all at the same orientation, all thanks to \lc{seth}.
\begin{logoout}
...
\begin{problem}
  Draw a picture (by hand or using a computer) showing how \lc{seth
    \#} points the turtle.
\end{problem}
...
\begin{problem}
  FIRST:  Explain in words what the \lc{circle} program is doing line-by-line.


  SECOND: Based on the \lc{circle} program above, make a new program
...
changing. Call this function \lc{house}. Show-off your work with your code and a picture.
\end{problem}
