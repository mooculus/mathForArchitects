...
\end{logo}
This produces a list of numbers. The command \lc{print} is used to
figure out values in programs while you write them.  Using
\lc{repcount} we can produce some really cool drawings, especially
when combined with commands that \lc{\%}, that mean ``take the
remainder.''
...
Here we use \lc{repeat} and \lc{repcount} to produce a picture of the
Sun.
\begin{logo}
...
\begin{problem}
  Use \lc{repcount} to help you make a command that will make
