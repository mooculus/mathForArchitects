...
\[
\raisebox{-.5\height}{\includegraphics[width=.2\textwidth]{wallpapertt.png}}\quad \text{and} \quad\raisebox{-.5\height}{\includegraphics[width=.2\textwidth]{wallpapertt2.png}}
\]
