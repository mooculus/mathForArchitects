...
Here is a schematic diagram of the situation:
    ...
    \item The the measure of angle $\alpha$ is the same as the measure
      of angle $\beta$. 
    \end{enumerate}
    If you use a famous theorem in the parts above, you need to
...
\begin{enumerate}
 \item Use this new information, along with the previous problems, to
   estimate the circumference of the Earth. EXPLAIN exactly how the problems before this lead to the solution.
