...
\begin{enumerate}
 \item The original LEGO minifigure is $4$ centimeters tall. How tall is the
   wooden model? Respect significant digits and explain your reasoning.
...
%%   of the stud on the wooden model?
 \item The body of the wooden model is $50$ millimeters thick. How
   thick is the original LEGO minifigure?  Respect significant digits and explain your reasoning.
...
\begin{enumerate}
 \item What is the scale factor from the original LEGO minifigure?
   What about from the wooden model in the Instructables article? Respect significant digits and explain your reasoning.
