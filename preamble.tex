...
\DefineVerbatimEnvironment{logo}{Verbatim}{frame=lines,label=\LOGO,labelposition=topline}
\NewEnviron{logoout}{
\begin{center}
...
\usepackage{fdsymbol}
\newcommand{\turtle}{\text{$\blacktriangle$}}
\newcommand{\turtler}{\text{$\blacktriangleright$}}
\newcommand{\turtlel}{\text{$\blacktriangleleft$}}
\newcommand{\turtled}{\text{$\blacktriangledown$}}
