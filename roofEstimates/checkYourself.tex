...
%    \node at (1.9,1.6) {$15'$};
  ...
  \end{tikzpicture}
 \end{center}
  What SINGLE ADDITIONAL piece of information will allow you to MOST EASILY
...
\begin{exercise}
  ...
  \begin{enumerate}\begin{multicols}{2}
    ...
    \item around $2,500$ square feet %e correct
