...
\end{center}
Here's two  questions we may want answered: What's area of the roof? Given the SLOPE of the roofs that
meet, what is the slope (or pitch) of the hip or valley? We'll think about the second question in this activity.
...
\item Assuming that the hip-end has a slope of $\tfrac{6}{12}$, and
  that the roof has an overhang of $2$ feet on all sides, find the slope of the hip.
 ...
 \item Considering the $1$-car garage from the previous part, now
   ...
   overhang of $2$ feet. Assume that the main roof still has a slope of $\tfrac{6}{12}$ with an overhang of $2$ feet. Find the slope of the hip.
\end{enumerate}
...
\end{quote}
  ...
  %% \begin{enumerate}
%\item
  Someone used this drawing to compute the slope of a hip.
    \begin{center}
        \begin{tikzpicture}[geometryDiagrams,scale=.2]
          %% \filldraw[black] (1in,1in) circle (2pt) ;
          %% \filldraw[black] (0in,0in) circle (2pt) ;
    ...
    of the hip-end, find the slopes (as a fraction over $12$) of
    \begin{itemize}
    \item the main roof,
    \item the hip-end,
    \item and the hip.
 ...
 % \item Suppose you have a main-roof with a slope of $\frac{4}{12}$
  ...
  %  \textbf{find the slope of the hip.}  Show all work and explain your
  %  reasoning.%, and check your work with an \link[online calculator]{https://www.blocklayer.com/roof/hipeng}.
...
\begin{question}
  If the slope of the main roof is the SAME as the slope of the
  hip-end, say they are both $\frac{p}{12}$, then the slope of the hip
  or valley is about $p/17$. Explain why this simple trick works.
...
%      $(a)$ above.
  \begin{freeResponse}
      In very short terms, it's becasue $12\sqrt{2} \approx 16.97\approx 17$. 
  \end{freeResponse}
\end{question}
