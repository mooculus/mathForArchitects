...
Dr.\ Snapp was browsing the INTERNET for a dog house. They come in different
  ...
  \begin{question}
    \begin{enumerate}
      \item Complete the table below. As a gesture of friendship, I've
        completed the first and last columns.
        \[
        ...
        \]
	\end{question}
  \item Find the percent increase of each value in the table
      above. The top and bottom rows have already been filled in.
      \[
    \renewcommand{\arraystretch}{3}
    \begin{array}{|c||c|c|c|}
      \hline
 ...
 Finally, let's compare the percent increases that we found in
    ...
    below. The first column has already been filled in. %%%I don't really know what Bart was going for here. Updated to reflect (27/10) as Price/width increase for small-> large--Claire Merriman
    \[
    \renewcommand{\arraystretch}{3}
