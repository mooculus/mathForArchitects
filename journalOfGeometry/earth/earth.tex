...
Here is a schematic diagram of the situation:
    \begin{center}
      ...
      \end{tikzpicture}
    \end{center}
    Use ideas from this class to explain why the measure of angle
...
\mynewpage
  ...
  \begin{question} Here is a accurate, up-to-scale, drawing of the stick and the shadow.  Identify and measure the relevant angle(s):
    ...
    \begin{center}
        ...
        \coordinate (O) at (0,0);
        \coordinate (T) at (0,6);
        \coordinate (S) at (-.75,0);
        \tkzDrawSegment[line width=2mm,black](O,S)
        \tkzDrawSegment[line width=2mm, black!20!brown,line cap=rect](O,T)
        \end{tikzpicture}
    \end{center}
