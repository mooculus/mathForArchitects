...
\begin{question}
  ...
  \]
  All losing votes are wasted. Moreover, some ``winning'' votes could be wasted.
  \begin{enumerate}
  ...
  \end{enumerate}
\end{question}
See \link{https://www.brennancenter.org/sites/default/files/legal-work/How\_the\_Efficiency\_Gap\_Standard\_Works.pdf} for more information on the efficiency gap.
