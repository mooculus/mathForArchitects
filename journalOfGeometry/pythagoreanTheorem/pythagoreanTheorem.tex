...
\begin{question}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \end{tikzpicture}
  \end{center}
  A gif version of the diagrams is on the assignment page in Carmen. A GeoGebra file for specific examples are in the Week 8 Module. 
  
 \emph{Explain why }the Pythagorean theorem is true.  Use the pictures
  above, words, perhaps additional pictures, and so on, as
  needed/helpful in your explanation. Make sure that your answer has variable, not numbers.
