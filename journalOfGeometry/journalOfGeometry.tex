...
%%
%% Redo this: the emphasis needs to be on the following: 
%% Finding lower bounds for areas of roofs.
%% Understanding that a Steeper roof MUST have a larger area.
%% Show houses with floor plans, give reasonable estimates for the areas of the roofs
%% Garage from not so quick questions?
%% floor plans -- airel views of houses etc.
%% Show houses with different roofs, including conical roofs.  ask which has the greatest area, and request minimum area (or give orders of magnitude)
...
%%  (STRENGTH SHOULD BE FOUND VIA CROSS-SECTIONAL AREA)!!!!
%%   WEIGHT SCALES BY VOLUME
%% THE FUNDAMENTAL PROBLEM WITH LARGE OBJECTS
...
\activity{combinationsOfSym/combinationsOfSym.tex}  %% BADBAD --- rewrite in terms of being able to get the function from compositions
%% question 1 gives the way!
%% line of f's FFFFFFFFFF


\activity{fiveTypesOfSym/fiveTypesOfSym.tex}  %%  BADBAD
%% NEEDS PREAMBLE OF WHAT's GOING ON.

%% BAD BAD FREIEZE EXPLORER  Unclear where the rotation is around.

\activity{manyTypesOfPizza/manyTypesOfPizza.tex} %%  3C and 3D probably need to be switched.
