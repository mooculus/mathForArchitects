\documentclass[hints,numbers,nooutcomes,handout]{xourse}
...
\checkstyle \activity{areaOfTriangles/checkYourself.tex}
...
\checkstyle\activity{volumeOfPyramids/checkYourself.tex} %% DONE  
\journalstyle
\activity{roofEstimates/roofEstimates}


\activity{formulasGalore/formulasGalore.tex}  %% DONE  REQUIRED 
\checkstyle\activity{formulasGalore/checkYourself.tex} %% DON
...
%\activity{rainRain/rainRain.tex}
...
\activity{miniMe/miniMe.tex}
\checkstyle
\activity{supersizeMe/checkyourself.tex} %% DONE
\journalstyle
...
\activity{anglesAndRightTriangles/anglesAndRightTrianglesAU21.tex} %% DONE  REQUIRED     THIS SHOULD FOCUS ON RATIOS MORE!!!!!!
