...
\begin{enumerate}
 \item The original LEGO minifigure is $4 \ cm$ tall. How tall is the
   wooden model?
...
\begin{question}
 Say you want to make a life-size wooden LEGO man that is $1.75 \ m$
 tall.
...
\begin{question}
  Let's compare the model from the Instructables article to a
  life-size model.
  \begin{enumerate}
