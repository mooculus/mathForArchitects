...
%%  piece of string? euler phi...
  ...
  \begin{freeResponse}
    ...
    \item
      \begin{center}
        \includegraphics[width=.3\textwidth]{starsSub15-5-2Script.png}   \qquad \fbox{\includegraphics[width=.3\textwidth]{starsSub15-5-2Stage.png}}
      \end{center}
    \item
      \begin{center}
        \includegraphics[width=.3\textwidth]{starsSub21-3-1Script.png}   \qquad \fbox{\includegraphics[width=.3\textwidth]{starsSub21-3-1Stage.png}}
      \end{center}
    \item \begin{center}
      \includegraphics[width=.3\textwidth]{starsSub21-7-2Script.png}   \qquad \fbox{\includegraphics[width=.3\textwidth]{starsSub21-7-2Stage.png}}
    \end{center}
    \end{enumerate}
  \end{freeResponse}
\end{question}
