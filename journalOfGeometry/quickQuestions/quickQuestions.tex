...
\begin{question}
  You decide to buy an inflatable pool that is $10$ feet wide and $4$
  feet deep:
  \begin{center}
  ...
  \begin{enumerate}
    ...
    \item Now that you have the pool, you plan to have a pool party at
      ...
      inches wide and $2$ inches deep with water in just $2$ seconds,
...
\item How does the cost of the raw materials will change if the radius
  is reduced by $10\%$?
\item How does the capacity will change if the radius is reduced by
  $10\%$?
\item How does the filled-weight will change if the radius is
  increased by $10\%$?
\item How does the empty-weight will change if the radius is increased
  by $10\%$.
\item How does the filled-weight will change if the empty-weight is
  increased by $10\%$.
\end{enumerate}
