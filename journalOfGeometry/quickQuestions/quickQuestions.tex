...
\begin{question}
  ...
  \begin{enumerate}
    ...
    \item Now that you have the pool, you plan to have a pool party at
      ...
      inches wide and $1.5$ inches deep with water in just $1$ second,
      \textbf{when should you start filling your pool to ensure it is
        ready by $\boldsymbol 4$pm?}  Explain your reasoning.
  \end{enumerate}
  \begin{freeResponse}
    \begin{enumerate}
    ...
    \item So, the pool has
      ...
      or
      \[
      \frac{13824}{60\cdot 60} \approx 4~\text{hours}.
      \]
      We should start filling the pool at noon to be ready by $4$pm.
    \end{enumerate}
  \end{freeResponse}
\end{question}
\mynewpage
