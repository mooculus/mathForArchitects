...
, font=\small\sffamily,}%font=\wedn\bfseries\upshape,}
\newenvironment{listObjectives}{\begin{mdframed}[style=OutcomeStyle]The following questions address these semester-long Learning Goals:\begin{itemize}}{\end{itemize}\end{mdframed}}
...
\newcommand{\checkYourselfAbstract}{\begin{abstract} Set a timer and
    ...
    ten minutes. Make sure you can explain why each of your answers is true.
\end{abstract}}
