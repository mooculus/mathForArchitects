...
, font=\small\sffamily,}%font=\wedn\bfseries\upshape,}
\newenvironment{listObjectives}{\begin{mdframed}[style=OutcomeStyle]The following questions addresses these semester-long Learning Goals:\begin{itemize}}{\end{itemize}\end{mdframed}}
...
\newcommand{\checkYourselfAbstract}{\begin{abstract} Set a timer and
    ...
    twenty minutes. Make sure you can explain why each is true or false.
\end{abstract}}
