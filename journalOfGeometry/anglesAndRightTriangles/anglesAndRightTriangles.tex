...
\begin{question}
  ...
  In each case, make \snap\ scripts that will draw these triangles.
    ...
    \includegraphics{basicScriptRightBlank.png}}
      ...
      \snap\ script on the left.
      
  Now you should use the bisection method to find the angle for the
  final turn to within $1$ unit of the turtle's starting point.

  Show off your work using the bisection method with a TABLE as we
  have done before. Show off your \snap\ scripts by giving screenshots
  of your SCRIPTS and STAGES.
     \end{tabular}}
