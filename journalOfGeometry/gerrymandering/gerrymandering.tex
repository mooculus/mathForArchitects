...
\begin{question}
  ...
  the districts should be. According to the document \link[\textit{Redistricting in Ohio}]{https://www.lsc.ohio.gov/documents/reference/current/membersonlybriefs/134\%20Redistricting\%20in\%20Ohio.pdf}, districts must be:
  \begin{enumerate}
  \item Compact.
