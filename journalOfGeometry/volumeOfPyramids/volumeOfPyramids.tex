...
\begin{question}
  ...
  three identical square-based pyramids.
  \begin{freeResponse}
    Here they are:
    \begin{center}
    \begin{tikzpicture}
...
\begin{question} 
  Use your work above to derive a formula for the volume of the pyramids in the previous problem. Assume that the height is $s$ with an $s\times s$ square base.
  \begin{freeResponse}
